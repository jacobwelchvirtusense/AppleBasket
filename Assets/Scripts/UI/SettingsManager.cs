...
public class SettingsManager : MonoBehaviour
{
    ...
    [SerializeField] private IndexedSettingSlot movementTypeSettingSlot;
    ...
    {
        inputType++;
        inputType %= movementTypeSettingSlot.GetSlotAmount();
        RefreshInputType();
    }
    ...
    {
        movementTypeSettingSlot.SetCurrentSlotIndex(inputType);
